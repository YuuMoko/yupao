package com.yuki.usercenter.config;
...
public class Knife4jConfiguration {
    ...
    public Docket defaultApi2() {
        ...
        ApiInfo apiInfoBuilder = new ApiInfoBuilder().title("Knife4j")
                .description("Knife4j swagger-bootstrap-ui RESTful APIs ~~~~~")
                .termsOfServiceUrl("http://www.xxx.com")
                .contact(new Contact("YuuMoko", "https://github.com/yuumoko", "2772337221@qq.com"))
                .version("1.0")
                .build();
...
//                .apis(RequestHandlerSelectors.basePackage("com.moon.controller"))
                .apis(RequestHandlerSelectors.basePackage("com.yuki.usercenter.controller"))
